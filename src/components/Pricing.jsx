        ...
        <div className='w-full text-white my-24'>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                ...
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <p className='text-3xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium, libero alias. Temporibus excepturi aut ipsum possimus similique magnam. Perspiciatis, dolore!</p>
                </div>
                ...
                <div className='grid md:grid-cols-2'>
                    ...
                    <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                        ...
                        <div className='text-2xl '>
                            <p className='flex py-4'><CheckIcon className='w-8 mr05 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><CheckIcon className='w-8 mr05 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><CheckIcon className='w-8 mr05 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><CheckIcon className='w-8 mr05 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><CheckIcon className='w-8 mr05 text-green-600' />Lorem, ipsum dolor.</p>
